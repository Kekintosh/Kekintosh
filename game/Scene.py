...
class Scene:
    ...
    def updateScene(self):
        ...
        walking = self.player.is_moving()  # Check if player is walking
        self.player.inventory.update_viewmodel(current_time, walking)
        
        self.clouds.update()
        self.droppedBlock.update()
        self.player.inventory.draw_viewmodel()
